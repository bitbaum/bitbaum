...
**Public site:** [bitbaum.orangecat.ch](https://bitbaum.orangecat.ch) · **Companies registry:** `site/companies.json`
...
> This README contains strategic planning and internal documentation. For the public-facing parent site, see `site/` directory.
