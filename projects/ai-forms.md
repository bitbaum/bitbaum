...
**URL:** [github.com/catomean/ai-forms](https://github.com/catomean/ai-forms) (public); **not on npm** — installed via git tag (`npm install github:catomean/ai-forms#v0.1.0`)
